/** Compatibility exports for existing pages; implementation is grouped by UI purpose. */
export { Icon, Spinner, Panel, ErrorNote, ActionBar, Disclosure, Reveal, ConfirmDialog, EmptyState,
  Outcome, StaleBanner, Metric, InputStrip, Stat, Meter } from "./ui/layout";
