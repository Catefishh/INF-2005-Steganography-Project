// Sample payloads required by the INF2005 ACW1 brief (section 5, "various payload sizes").

/** Short message: Learning Outcome 1. */
...
/** Large message: the Project Overview paragraph. */
